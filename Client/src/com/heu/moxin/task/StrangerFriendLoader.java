...
public class StrangerFriendLoader extends FriendLoader {
	public static final String TAG = "StrangerFriendLoader";
	public StrangerFriendLoader(String phoneList, Context context,
			Handler handler) {
	...
	public void run() {
		...
		try {
			String url = Constant.URL_Compatibility_Friend;
